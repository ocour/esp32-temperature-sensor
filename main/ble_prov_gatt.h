#ifndef H_BLE_PROV_GATT_
#define H_BLE_PROV_GATT_
...
struct prov_data {
    ...
    char pwd[WIFI_PWD_MAX_SIZE];
    uint8_t pwd_len;

    char aws_uuid[AWS_UUID_MAX_SIZE];
    uint8_t aws_uuid_len;

    char aws_thing[AWS_THING_NAME_MAX_SIZE];
    uint8_t aws_thing_len;
};
